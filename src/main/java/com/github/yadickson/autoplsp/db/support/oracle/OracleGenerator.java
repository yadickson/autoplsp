...
public class OracleGenerator extends Generator {
    ...
    public String getTablesQuery() {
        return "SELECT ut.table_name name,\n"
                ...
                + "trunc(DECODE(utc.char_used, null, utc.data_precision, utc.CHAR_LENGTH)) fieldmaxsize,\n"
                ...
                + "CASE WHEN (utc.data_type = 'CLOB' OR utc.data_type = 'NCLOB' OR utc.char_used = 'B')\n"
                + "     THEN 'Byte'\n"
                + "     WHEN utc.char_used = 'C'\n"
                + "     THEN 'Char'\n"
                + "     ELSE null\n"
                + "     END fieldcharused\n"
                + "FROM user_tables ut\n"
