...
<#if interfaceFolderName != cursorFolderName>
...
public interface ${parameter.javaTypeName} extends${'\n'}    <#list parameter.parameters as parameter2>${parameter2.javaFileNameInterface}<#sep>,${'\n'}    </#sep></#list> {
}
