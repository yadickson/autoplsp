...
/**
 * Pruebas para la clase DateParameter
 *
 * @author Yadickson Soto
 */
public class DateParameterTest {

    private DateParameter parameter;

    @Before
    public void setup() {
        parameter = new DateParameter(0, null, Direction.INPUT, "", new Procedure(true, "", "", "", ""), "", "");
    }
    ...
    public void testGetSqlType() throws BusinessException {
        ...
        assertEquals(java.sql.Types.TIMESTAMP, sqlType);
    }
