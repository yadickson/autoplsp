...
public class OracleMakeParameterTest {
    ...
    public void testNullType() throws BusinessException {
        maker.create(null, 0, null, Direction.INPUT, null, null, new Procedure(true, "", "", "", ""), "", "");
    }

    @Test(expected = Exception.class)
    public void testUnknowType() throws BusinessException {
        maker.create("xx", 0, null, Direction.INPUT, null, null, new Procedure(true, "", "", "", ""), "", "");
    }
    ...
    public void testRefCursorInputError() throws BusinessException {
        maker.create("cursor", 1, "rcName", Direction.INPUT, null, null, new Procedure(true, "", "", "", ""), "", "");
    }
    ...
    @Test
    public void testRefCursorWithoutPackageName() throws BusinessException {
        ...
        assertEquals("rcName", parameter.getFieldName());
        assertEquals(Direction.OUTPUT, parameter.getDirection());
        assertEquals("TestRcNameRS", parameter.getJavaTypeName());
    }

    @Test(expected = Exception.class)
    public void testObjectOutputError() throws BusinessException {
        maker.create("object", 1, "objName", Direction.OUTPUT, null, null, new Procedure(true, "", "", "", ""), "", "");
    }
    ...
    public void testTableOutputError() throws BusinessException {
        maker.create("table", 1, "tName", Direction.OUTPUT, null, null, new Procedure(true, "", "", "", ""), "", "");
    }
