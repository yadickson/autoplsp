...
*/
    ...
    public void testGetJavaTypeName() throws BusinessException {
        OracleObjectParameter parameter = new OracleObjectParameter(1, "nameObject", Direction.INPUT, "", new Procedure(true, "", "", "", ""), null, "type_value", "ObjectSuffix", "");
    ...
    public void testGetSqlType() throws BusinessException {
        OracleObjectParameter parameter = new OracleObjectParameter(1, "nameObject", Direction.INPUT, "", new Procedure(true, "", "", "", ""), null, "type_value", "", "");
